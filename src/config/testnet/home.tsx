    ...
    return (
      <AppLayout section="home">
        <div style={{ maxWidth: '500px' }}>
          ...
          <p>This is a gateway to access LeapDAO Testnet chain.</p>
          <p>The chain runs <b>The Raft</b> version of the LeapDAO chain software:</p>
          ...
          <p><b>The Raft</b> is the first step of the LeapDAO\'s roadmap to eventually run a public Plasma network governed by DAO and supporting provable computations. You can read more about our development proposition here: <a href="https://docs.google.com/document/d/1vStTjqvqZGyiI5AVtpwCIMlHFnzC_4bbixsCfs27-M8/edit">Plasma Leap whitepaper</a></p>
          <h1>Next steps</h1>
          <p>
            <strong>As a user</strong>, you can try out the network:
          </p>
          <ol style={{ marginInlineStart: '1.5em' }}>
            {CONFIG.tokenFaucet && (<li><a href="/faucet">Get</a> some LEAP tokens on Rinkeby</li>)}
